...
## Problem 1-Pager
- **배경**: [ARCHITECTURE.md](../ARCHITECTURE.md) 기반 Slack 주식 리포트 봇은 신뢰할 수 있는 공시·뉴스·SNS 데이터 파이프라인이 필요하다.
...
- [x] Step 4 — 커넥터 추상화 및 News API 커넥터 구현 (RSS 커넥터는 MVP 제외), 응답 정규화·재시도/중복 방지 유닛 테스트.
